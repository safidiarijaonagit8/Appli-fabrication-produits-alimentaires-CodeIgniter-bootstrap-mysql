...
<div class="cart-box-main">
     <div class="container">
            <div class="row">
                ...
                <form action="<?php echo base_url();?>AdminController/fabrication" method="post">
                ...
                <button type="submit" class="btn btn-primary" >Valider fabrication</button>
                </form>
                <?php if (isset($listepf)) {?>
               
                    <h1 id="center"> Liste fabrication effectuee</h1>
                <div class="table-main table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                            <?php for ($j=0; $j < count($listepf) ; $j++) { ?>
                                <tr>
                                    <td class="name-pr">
                                    <?php echo $listepf[$j]['nomproduit'];?>
								    </td>
                                    <td class="price-pr">
                                        <p><?php echo $listepf[$j]['qteentree'];?>  </p>
                                    </td>
                ...
                <?php }?>
                            ...
                            <?php if (isset($qteinsuff)) {?>
               
               <h1 id="center"> Quantite insuffisante d ingredients</h1>
           <div class="table-main table-responsive">
                   <table class="table">
                       <thead>
                           <tr>
                               <th>nom</th>
                               <th>reste stock (kg)</th>
                               <th>qte ilaina (kg)</th>
                               <th>qte produit vitany (kg)</th>
                       ...
                       <?php for ($j=0; $j < count($detailfabricationprevision) ; $j++) { ?>
                           <tr>
                               <td class="name-pr">
                               <?php echo $detailfabricationprevision[$j]['nom'];?>
                               </td>
                               <td class="price-pr">
                                   <p><?php echo $detailfabricationprevision[$j]['reste'];?>  </p>
                               </td>
                               <td class="price-pr">
                                   <p><?php echo $detailfabricationprevision[$j]['qteilaina'];?>  </p>
                               </td>
                               <td class="price-pr">
                                   <p><?php echo $detailfabricationprevision[$j]['vitanymp'];?>  </p>
               ...
               <h2 id=''> quantite produit possible vita :  <?php echo $detailfabricationprevision[0]['vitanymp'];?> kg</h2>
           <?php }?>   
