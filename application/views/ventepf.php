     ...
     <div class="container">
            <div class="row">
                ...
                <?php if (isset($message)) {?>
                    <h1 id="center"> <?php echo $message;?></h1>
                    <?php }?>
                    <?php if (isset($restes)) {?>
                    <h1 id="center">reste :  <?php echo $restes;?></h1>
                    <?php }?>
                <form action="<?php echo base_url();?>AdminController/verificationvente" method="post">
                <label for="pet-select">Produits finis</label>
                ...
                <button type="submit" class="btn btn-primary" >Valider vente</button>
                </form>
                <?php if (isset($listepfvendu)) {?>
               
                    <h1 id="center"> Vente produit fini effectuee</h1>
                <div class="table-main table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                            <?php for ($j=0; $j < count($listepfvendu) ; $j++) { ?>
                                <tr>
                                    <td class="name-pr">
                                    <?php echo $listepfvendu[$j]['nomproduit'];?>
								    </td>
                                    <td class="price-pr">
                                        <p><?php echo $listepfvendu[$j]['qtesortie'];?>  </p>
                                    </td>
                                    <td class="price-pr">
                                        <p><?php echo $listepfvendu[$j]['daty'];?>  </p>
                                    </td>
           ...
           <div class="table-main table-responsive">
                   <table class="table">
                       ...
                       <tbody>
                       <?php for ($j=0; $j < count($detailfabrication) ; $j++) { ?>
                           <tr>
                               <td class="name-pr">
                               <?php echo $detailfabrication[$j]['nom'];?>
                               </td>
                               <td class="price-pr">
                                   <p><?php echo $detailfabrication[$j]['reste'];?>  </p>
                               </td>
                               <td class="price-pr">
                                   <p><?php echo $detailfabrication[$j]['qteilaina'];?>  </p>
                               </td>
