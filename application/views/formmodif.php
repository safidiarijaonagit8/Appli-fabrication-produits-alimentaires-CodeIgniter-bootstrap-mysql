...
<div class="cart-box-main">
     <div class="container">
            <div class="row">
                ...
                <form action="<?php echo base_url();?>AdminController/updateformule" method="post">
                <label for="pet-select">Matieres premieres</label>
              
                <select name="idmatiereupdate">
                <?php for ($j=0; $j < count($listematiere) ; $j++) { ?>
                    ...
                    <input type="number" name="qteupdate">  kg
                    <input type="hidden" name="idfabrication" value="<?php echo $fabrication; ?>">
