...
<div class="cart-box-main">
     <div class="container">
            <div class="row">
				...
				<?php if (isset($etatstock)) {?>
               
                    <h1 id="center"> Etat Stock</h1>
                <div class="table-main table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                            <?php for ($j=0; $j < count($etatstock) ; $j++) { ?>
                                <tr>
                                    <td class="name-pr">
                                    <?php echo $etatstock[$j]['nom'];?>
								    </td>
                                    <td class="price-pr">
                                        <p><?php echo $etatstock[$j]['reste'];?>  </p>
                                    </td>
                                    <td class="price-pr">
                                        <p><?php echo $etatstock[$j]['seuil'];?>  </p>
                                    </td>
