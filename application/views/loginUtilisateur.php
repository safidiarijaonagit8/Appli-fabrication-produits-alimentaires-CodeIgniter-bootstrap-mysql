            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>Welcome">Home</a></li>
                        <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>AdminController">Se connecter Admin</a></li>
...
<div class="cart-box-main">
     <div class="container">
            <div class="row">
                ...
                <?php }?>
                <h2 id="centrer"> Connexion utilisateur </h2>
                    <form action="<?php echo base_url();?>UtilisateurController/login" method="post" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="exampleInputPassword1" name="mdpUtilisateur">
                        </div>
