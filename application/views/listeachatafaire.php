...
<div class="cart-box-main">
     <div class="container">
            <div class="row">
				...
				<?php if (isset($achatafaire)) {?>
               
                    <h1 id="center"> Liste achat a faire  <button >Exporter</button></h1>
                <div class="table-main table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                            <?php for ($j=0; $j < count($achatafaire) ; $j++) { ?>
                                <tr>
                                    <td class="name-pr">
                                    <?php echo $achatafaire[$j]['nom'];?>
								    </td>
                                    <td class="price-pr">
                                        <p><?php echo $achatafaire[$j]['reste'];?>  </p>
                                    </td>
                                    <td class="price-pr">
                                        <p><?php echo $achatafaire[$j]['seuil'];?>  </p>
                                    </td>
