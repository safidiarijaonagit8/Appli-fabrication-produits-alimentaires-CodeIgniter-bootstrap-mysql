...
<div class="cart-box-main">
     <div class="container">
            <div class="row">
                ...
                <h1 id="center"> Liste demande a valider</h1>
                <div class="table-main table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                            <?php for ($j=0; $j < count($listeUtilisateur) ; $j++) { ?>
                                <tr>
                                    <td class="name-pr">
                                    <?php echo $listeUtilisateur[$j]['nom'];?>
								    </td>
                                    <td class="price-pr">
                                        <p><?php echo $listeUtilisateur[$j]['prenom'];?>  </p>
                                    </td>
                                    <td class="price-pr">
                                        <p><?php echo $listeUtilisateur[$j]['email'];?>  </p>
                                    </td>
                                    <td class="price-pr">
                                        <p><?php echo $listeUtilisateur[$j]['sexe'];?>  </p>
                                    </td>
                                    <td class="price-pr">
                                <form action="<?php echo base_url();?>AdminController/valider"  method="post">
                                    <input type="hidden" name="idutilisateur" value="<?php echo $listeUtilisateur[$j]['idutilisateur'];?>">
