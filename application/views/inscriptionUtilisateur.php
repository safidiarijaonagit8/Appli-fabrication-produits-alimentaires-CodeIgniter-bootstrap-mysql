            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>Welcome">Home</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>Welcome">Se connecter</a></li>
...
<div class="cart-box-main">
     <div class="container">
            <div class="row">
                ...
                <?php if (isset($erreur)) {?>
                <h1> Vous n'etes pas encore inscrit </h1>
                <?php }?>
                <h2 id="centrer"> Inscription utilisateur </h2>
                    <form action="<?php echo base_url();?>UtilisateurController/insertioninscription" method="post">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nom</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="nomUtilisateur">
                            
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Prenom</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="prenomUtilisateur">
                            
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Date de naissance</label>
                            <input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="dtnUtilisateur">
                            
                        </div>
                    <div>
                        
                        <div>
                        <input type="radio" id="huey" name="sexe" value="masculin">
                        <label for="huey">Masculin</label>
                        </div>

                        <div>
                        <input type="radio" id="dewey" name="sexe" value="feminin">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="emailUtilisateur">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Mot de passe</label>
                            <input type="password" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="mdpUtilisateur">
                        </div>
                        
                            <button type="submit" class="btn btn-primary" id="centrer">S'inscrire</button>
                        </form>
                </div>
