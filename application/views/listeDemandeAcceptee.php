            ...
            <div class="row">
                ...
                <div class="table-main table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                            <?php for ($j=0; $j < count($listedemandeacceptee) ; $j++) { ?>
                                <tr>
                                    <td class="name-pr">
                                    <?php echo $listedemandeacceptee[$j]['nom'];?>
								    </td>
                                    <td class="price-pr">
                                        <p><?php echo $listedemandeacceptee[$j]['prenom'];?>  </p>
                                    </td>
                                    <td class="price-pr">
                                        <p><?php echo $listedemandeacceptee[$j]['email'];?>  </p>
                                    </td>
                                    <td class="price-pr">
                                        <p><?php echo $listedemandeacceptee[$j]['sexe'];?>  </p>
                                    </td>
                                    <td class="price-pr">
